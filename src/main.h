...
extern float screen_zoom, screen_center_x, screen_center_y, scr_zoo;
void reset_screen();
...
extern const color_t COLOR_CANONBALL;
extern const color_t COLOR_BARREL;
extern const color_t COLOR_TRIFORCE;
extern const color_t COLOR_BLACK;
extern const color_t COLOR_OCTOROK;
